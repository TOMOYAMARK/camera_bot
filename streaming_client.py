...
if __name__ == '__main__':
    config = configparser.ConfigParser()
    config.read('./connection.ini', 'UTF-8')
    StreamingClientApp(view_fps=int(config.get('client_settings', 'view_fps')), view_width=int(config.get('client_settings', 'view_width')), view_height=int(config.get('client_settings', 'view_height'))).run()
